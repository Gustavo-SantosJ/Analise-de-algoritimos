...
public class Gerador_De_100000_Valores {
	public static void main(String[] args) throws IOException {
		...
		Scanner in = new Scanner(System.in);
			System.out.println(
					"Selecione 1 - Para 100.000 números 100% desordenados\n Selecione 2 - Para 100.000 números 50% desordenados\n Selecione 3 - Para 100.000 números 25% desordenados\n ");
		...
		case 1:// Gera números 100% desordenados
			...
			int[] vetor = new int[100000]; // cria o vetor com 100.000 posições
		...
		case 2: // Gera números 50% desordenados
			...
			int[] vetor1 = new int[100000]; // cria o vetor com 100.000 posições
		...
		case 3: // Gera números 25% desordenados
			...
			int[] vetor2 = new int[100000]; // cria o vetor com 100.000 posições
